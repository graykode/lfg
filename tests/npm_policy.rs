...
use lfg::npm_registry::{NpmRelease, ResolvedNpmReleases};
use lfg::policy::{ReleaseFacts, ReviewDecision, ReviewPolicy, SkipReason};

fn resolved_releases(target_published_at: &str) -> ResolvedNpmReleases {
    ResolvedNpmReleases {
        ...
        previous: NpmRelease {
            ...
            tarball_url: "https://registry.npmjs.org/left-pad/-/left-pad-1.0.0.tgz".to_owned(),
        },
    }
}
